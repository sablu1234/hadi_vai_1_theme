					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-7 col-12">
							...
							<ul class="top-contact">
								<li><i class="fa fa-phone"></i><?php echo get_option('cell');?></li>
		...
		<section class="pricing-table section">
			<div class="container">
				...
				if($the_meta->have_posts(  )):
					...
					$add_package_price=get_post_meta(get_the_id(),'add_package_price',true);
				...
				<div class="col-lg-4 col-md-12 col-12">
						<div class="single-table">
							...
							<div class="table-head">
								...
								<div class="price">
									<p class="amount">$<?php echo $add_package_price;?><span>/ Per Visit</span></p>
								</div>	
							</div>
							<!-- Table List -->
							<ul class="table-list">
							...
							foreach($myfeature as $singlefeature){
