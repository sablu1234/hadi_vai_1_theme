...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Class Name', 'textdomain' ),
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'ADD package price', 'textdomain' ),
		'desc'       => esc_html__( 'ADD package price', 'textdomain' ),
		'id'         => 'add_package_price',
		'type'       => 'text',
		
	) );

	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'ADD Booking URL', 'textdomain' ),
		'desc'       => esc_html__( 'ADD Booking URL', 'textdomain' ),
		'id'         => 'addbookingurl',
		'type'       => 'text_url',
