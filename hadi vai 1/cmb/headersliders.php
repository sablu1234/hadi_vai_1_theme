...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		...
		'title'         => esc_html__( 'Our Feature', 'cmb2' ),
		'object_types'  => array( 'header_slider' ), // Post type
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Booking Link', 'cmb2' ),
		'desc' => esc_html__( 'contact site', 'cmb2' ),
		'id'   => 'bookinglink',
		'type' => 'text_url',
	) );
	
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Contact link', 'cmb2' ),
		'desc' => esc_html__( 'contact site', 'cmb2' ),
		'id'   => 'contactlink',
		'type' => 'text_url',
	) );
