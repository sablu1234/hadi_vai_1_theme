...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Class Name', 'cmb2' ),
		'desc'       => esc_html__( 'Add Icon Class', 'cmb2' ),
		'id'         => 'iconclass',
		'type'       => 'text',
		
	) );
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Booking URL', 'cmb2' ),
		'desc'       => esc_html__( 'Add Booking URL', 'cmb2' ),
		'id'         => 'addbookingurl',
		'type'       => 'text_url',
		
	) );
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Package Price', 'cmb2' ),
		'desc'       => esc_html__( 'Add Package Price', 'cmb2' ),
		'id'         => 'package_price',
		'type'       => 'text',
