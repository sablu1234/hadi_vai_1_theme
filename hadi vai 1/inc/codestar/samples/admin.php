...
CSF::createOptions( $prefix, array(
  'menu_title' => 'mamur jor theme option',
  'menu_slug'  => 'csf-demo',
) );
...
CSF::createSection( $prefix, array(
  ...
  'fields'      => array(
    ...
    array(
      'id'    => 'booking_appoint_url',
      'type'  => 'text',
      'title' => 'Booking Appoint URL',
    ),
...
CSF::createSection( $prefix, array(
  'parent'      => 'basic_fields',
  'title'       => 'Single content-1',
  'icon'        => 'far fa-square',
  'description' => 'Emergency Cases-Doctors Timetable-Opening Hours',
  'fields'      => array(
...
//
// Field: Single Content-2
//
CSF::createSection( $prefix, array(
  'parent'      => 'basic_fields',
  'title'       => 'Single content-2',
  'icon'        => 'far fa-square',
  'description' => 'Emergency Cases-Doctors Timetable-Opening Hours',
  'fields'      => array(
...
//
// Field: Single Content-3
//
CSF::createSection( $prefix, array(
  'parent'      => 'basic_fields',
  'title'       => 'Single content-3',
  'icon'        => 'far fa-square',
  'description' => 'Emergency Cases-Doctors Timetable-Opening Hours',
  'fields'      => array(
...
CSF::createSection( $prefix, array(
  ...
  'title'       => 'Treatment',
  'icon'        => 'far fa-square',
  'description' => 'We Are Always Ready to Help You & Your Family',
  'fields'      => array(

    array(
      'id'    => 'always_ready_m_title',
      'type'  => 'text',
      'title' => 'Always Main Ready',
    ),
    array(
      'id'    => 'always_ready_title',
      'type'  => 'text',
      'title' => 'Title',
    ),
...
CSF::createSection( $prefix, array(
  ...
  'fields'      => array(
    ...
    array(
      'id'    => 'about_services_main_title_description',
      'type'  => 'text',
      'title' => 'About Services Main Title Description',
    ),
    
    array(
      'id'    => 'about_services_title',
      'type'  => 'text',
      'title' => 'About Services Title',
    ),

    array(
      'id'    => 'about_services_title_description',
      'type'  => 'text',
      'title' => 'About Services Title Description',
    ),

       array(
      'id'     => 'about_services_repeater_1',
      'type'   => 'repeater',
      'title'  => 'About services Repeater 1',
      'fields' => array(
        array(
          'id'    => 'about_setvices_feature_1',
          'type'  => 'text',
          'title' => 'About Service Feature 1'
        ),
      ),
    ),

       array(
      'id'     => 'about_services_repeater_2',
      'type'   => 'repeater',
      'title'  => 'About services Repeater 2',
      'fields' => array(
        array(
          'id'    => 'about_setvices_feature_2',
          'type'  => 'text',
          'title' => 'About Service Feature 2',
        ),
      ),
    ),
