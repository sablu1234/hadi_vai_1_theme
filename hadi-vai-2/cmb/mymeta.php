...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Class Name', 'text_domain' ),
		'desc'       => esc_html__( 'Icon Class', 'text_domain' ),
		'id'         => 'iconclass',
		'type'       => 'text_medium',
	) );

	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Booking URL', 'text_domain' ),
		'desc'       => esc_html__( 'Add Booking URL', 'text_domain' ),
		'id'         => 'bookingurl',
		'type'       => 'text_url',
	) );

	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Package Price', 'text_domain' ),
		'desc'       => esc_html__( 'Add Package Price', 'text_domain' ),
		'id'         => 'package_price',
		'type'       => 'text',
	) );
