    ...
    <body>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-6 col-md-7 col-12">
							...
							$myoptionfield=get_option('myuniqueidthemeoption');
							// var_dump($myoptionfield);
							echo $myoptionfield['my_cell'];
							?>
					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="index.html"><img src="<?php echo $myoptionfield['logo']?>" alt="#"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<?php
										...
										$myoption_field=get_option( 'myuniqueidthemeoption' );
										$myfeaturelist=$myoption_field['about-feature'];
					...
					<div class="col-lg-6 col-12">
						...
						<div class="choose-right">
							<div class="video-image">
								...
								<!--/ End Video Animation -->
								<iframe width="560" height="315" src="<?php echo $myoption_field['about-video'];?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
							</div>
						</div>
						<!-- End Choose Rights -->
					</div>
		...
		<section class="pricing-table section">
			<div class="container">
				...
				$addiconclass=get_post_meta(get_the_id(),'addiconclass',true);
				$package_price=get_post_meta(get_the_id(),'package_price',true);
				$addbookingurl=get_post_meta(get_the_id(),'addbookingurl',true);

				$myfeature=get_post_meta(get_the_id(),'yourprefix_group_demo',true);
			...
			<div class="col-lg-4 col-md-12 col-12">
						<div class="single-table">
							...
							<div class="table-head">
								<div class="icon">
									<i class="<?php echo $addiconclass;?>"></i>
								</div>
							...
							<ul class="table-list">
								<?php
								foreach($myfeature as $siglefeature){
									
								
								?>
								<li><i class="icofont icofont-ui-check"></i><?php echo $siglefeature['title'];?></li>
								<?php
								}
